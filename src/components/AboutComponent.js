      ...
      <div className="container">
        ...
        <div className="row row-content">
          <div className="col-12 col-md-6">
            <h2>Our History</h2>
            <p>
              Started in 2010, Dishes on the Go quickly established itself as a
              culinary icon par excellence in Gurugram. With its unique brand of
              world fusion cuisine that can be found nowhere else, it enjoys
              patronage from the A-list clientele in Gurugram. Featuring four of
            ...
            <p>
              ...
              Mr. Prince, that featured for the first time the world's best
              cuisines in a pan.
            </p>
          </div>
            ...
            <Card>
              ...
              <CardBody>
                <dl className="row p-1">
                  ...
                  <dd className="col-6">SoftBank Inc., Japan</dd>
                  <dt className="col-6">Last Year's Turnover</dt>
                  <dd className="col-6">₹12,50,375</dd>
